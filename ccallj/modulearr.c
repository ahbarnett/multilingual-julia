...
// Note: output array is alloc by julia, passed back.
...
int main(int argc, char *argv[])
{
    ...
    JL_GC_PUSH1(&aj);     // per SO post, doesn't prevent segfaults
